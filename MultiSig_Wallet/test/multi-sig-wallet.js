...
contract("MultiSigWallet", (accounts) => {
  ...
  describe("constructor", () => {
    ...
    it("should reject if num_conf_req > owners", async () => {
      await expect(MultiSigWallet.new([owners[0]], NUM_CONFIRMATIONS_REQUIRED)).to.be
        .rejected
    })

    it("should reject if owners are not unique", async () => {
      await expect(MultiSigWallet.new([owners[0],  owners[0]], NUM_CONFIRMATIONS_REQUIRED)).to.be
        .rejected
    })
  })
  ...
  describe("submit transaction", () => {
    ...
    it("should reject if not owner", async () => {
      await expect(wallet.submitTransaction(to, value, data, { from: accounts[3], })).to.be
        .rejected
    })
  })
  ...
  describe("confirmTransaction", () => {
    ...
    it("should reject if tx already confrimed", async () => {
  ...
  describe("getTransactionCount", () => {
    it("should get num transactions", async () => {
